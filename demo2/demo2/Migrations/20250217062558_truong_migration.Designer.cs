...
namespace demo2.Migrations
{
    ...
    [Migration("20250217062558_truong_migration")]
    partial class truong_migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("demo2.Models.Diemthi", b =>
                {
            ...
            modelBuilder.Entity("demo2.Models.Lop", b =>
                {
            ...
            modelBuilder.Entity("demo2.Models.Lylich", b =>
                {
                    b.Property<string>("Mshv")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("demo2.Models.Monhoc", b =>
                {
                    b.Property<string>("Msmh")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("demo2.Models.Diemthi", b =>
                {
                    b.HasOne("demo2.Models.Lylich", "MshvNavigation")
                        .WithMany("Diemthis")
                        .HasForeignKey("Mshv")
                        .IsRequired()
                        .HasConstraintName("FK_diemthi_lylich");

                    b.HasOne("demo2.Models.Monhoc", "MsmhNavigation")
                        .WithMany("Diemthis")
                        .HasForeignKey("Msmh")
                        .IsRequired()
            ...
            modelBuilder.Entity("demo2.Models.Lylich", b =>
                {
                    b.HasOne("demo2.Models.Lop", "MalopNavigation")
                        .WithMany("Lyliches")
                        .HasForeignKey("Malop")
