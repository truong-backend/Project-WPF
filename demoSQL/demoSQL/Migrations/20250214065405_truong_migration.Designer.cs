...
namespace demoSQL.Migrations
{
    ...
    [Migration("20250214065405_truong_migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("demoSQL.Models.Chitiethoadon", b =>
                {
            ...
            modelBuilder.Entity("demoSQL.Models.Hanghoa", b =>
                {
                    b.Property<string>("Mahang")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("demoSQL.Models.Hoadon", b =>
                {
                    b.Property<string>("Sohd")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("demoSQL.Models.Chitiethoadon", b =>
                {
                    b.HasOne("demoSQL.Models.Hanghoa", "MahangNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Mahang")
                        .IsRequired()
                        .HasConstraintName("FK_chitiethoadon_hanghoa");

                    b.HasOne("demoSQL.Models.Hoadon", "SohdNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Sohd")
                        .IsRequired()
