...
namespace buoi2.Migrations
{
    ...
    [Migration("20250215061956_hoadon")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("buoi2.Models.Chitiethoadon", b =>
                {
            ...
            modelBuilder.Entity("buoi2.Models.Hanghoa", b =>
                {
                    b.Property<string>("Mahang")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("buoi2.Models.Hoadon", b =>
                {
                    b.Property<string>("Sohd")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("buoi2.Models.Chitiethoadon", b =>
                {
                    b.HasOne("buoi2.Models.Hanghoa", "MahangNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Mahang")
                        .IsRequired()
                        .HasConstraintName("FK_chitiethoadon_hanghoa");

                    b.HasOne("buoi2.Models.Hoadon", "SohdNavigation")
                        .WithMany("Chitiethoadons")
                        .HasForeignKey("Sohd")
                        .IsRequired()
